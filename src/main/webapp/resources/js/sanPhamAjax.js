    ...
    $(document).on("click",".btnChiTiet", function() {
		...
		$.get(href, function(sanPham) {
			...
			if(checkTenDanhMuc != -1){
			  ...
			  $('.thietKe').html("<span style='font-weight: bold'>Card màn hình: </span>"+ sanPham.thietKe);
			  $('.dungLuongPin').html("<span style='font-weight: bold'>Cân nặng: </span>"+ sanPham.dungLuongPin);
