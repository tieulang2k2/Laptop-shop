...
<body>
	...
	<div class="top-header">
		<div class="wrap">
			<!----start-logo---->
			<div class="logo">
				<a href="<%=request.getContextPath()%>/"><img style="max-width: 65%;" src="Frontend/img/logo.png" title="logo" /></a>		
			</div>
			<!----end-logo---->
			<!----start-top-nav---->
			<div class="top-nav">
				<ul>
					...
					<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Cửa hàng <span class="caret"></span></a>
						<ul class="dropdown-menu" style="background: #2c2c2c" id="danhmuc2">
						</ul></li>
					<li><a href="<%=request.getContextPath()%>/shipping">GIAO HÀNG VÀ THANH TOÁN</a></li>
