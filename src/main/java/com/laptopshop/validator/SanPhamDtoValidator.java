...
public class SanPhamDtoValidator implements Validator{
	...
	public void validate(Object target, Errors errors) {
		...
		if(tenDanhMuc.contains("Laptop".toLowerCase())) {
			...
			ValidationUtils.rejectIfEmpty(errors, "thietKe", "error.thietKe", "Card màn hình không được trống");
			ValidationUtils.rejectIfEmpty(errors, "dungLuongPin", "error.dungLuongPin", "Cân nặng được trống");			
		}
